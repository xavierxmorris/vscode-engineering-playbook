...
**All 98 paths below were verified to exist at that commit.** Each link opens the file as it was when the playbook was validated, so quoted code cannot drift out from under you.
...
| [`build/azure-pipelines/common/checkNativeOptionalDeps.ts`](https://github.com/microsoft/vscode/blob/7234ef01c2cace7cfa911d792ce9c5b1f333fca5/build/azure-pipelines/common/checkNativeOptionalDeps.ts) | 114 | Fails the Linux/macOS/Windows cache-warming jobs before save when a base package's host-specific binary sibling is missing | A |
...
| [`extensions/esbuild-extension-common.mts`](https://github.com/microsoft/vscode/blob/7234ef01c2cace7cfa911d792ce9c5b1f333fca5/extensions/esbuild-extension-common.mts) | 50 | Shared extension bundler options; promotes esbuild's `import-is-undefined` warning to an error | A |
| [`extensions/esbuild-webview-common.mts`](https://github.com/microsoft/vscode/blob/7234ef01c2cace7cfa911d792ce9c5b1f333fca5/extensions/esbuild-webview-common.mts) | 30 | Shared webview bundler options; same `import-is-undefined` promotion | A |
...
| [`src/vs/base/test/common/event.test.ts`](https://github.com/microsoft/vscode/blob/7234ef01c2cace7cfa911d792ce9c5b1f333fca5/src/vs/base/test/common/event.test.ts) | 1,957 | Emitter tests — pins nested-fire delivery order with a shared delivery queue | A |
