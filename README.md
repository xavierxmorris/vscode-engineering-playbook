...
>
> **Every VS Code code excerpt is permalinked to the pinned commit.** Look for the 🔗 citation line above each code block, or browse **[SOURCES.md](SOURCES.md)** for the complete index of all 96 cited files. Links include line numbers and cannot drift.

## 📚 Contents

| Document | Description |
|----------|-------------|
| [**SOURCES.md**](SOURCES.md) | **Source index** — all 96 cited `microsoft/vscode` files, pinned and permalinked |
...
6. **🛡️ Runtime Self-Defence** — Code that makes its own failures loud and attributable in production, not just in CI
